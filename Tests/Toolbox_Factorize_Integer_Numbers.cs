...
namespace ProjectEuler.Tests
{
    ...
    public class Toolbox_Factorize_Integer_Numbers
    {
        ...
        public void Returns_2_When_Factorizing_2()
        {
            ...
            CollectionAssert.AreEqual(new long[1] { 2 }, factors.ToList());
        }
        ...
        public void Returns_3_When_Factorizing_3()
        {
            ...
            CollectionAssert.AreEqual(new long[1] { 3 }, factors.ToList());
        }
        ...
        public void Returns_5_When_Factorizing_5()
        {
            ...
            CollectionAssert.AreEqual(new long[1] { 5 }, factors.ToList());
        }
        ...
        public void Returns_2_3_When_Factorizing_6()
        {
            ...
            CollectionAssert.AreEqual(new long[2] { 2, 3 }, factors.ToList());
        }
        ...
        public void Returns_7_When_Factorizing_7()
        {
            ...
            CollectionAssert.AreEqual(new long[1] { 7 }, factors.ToList());
        }
        ...
        public void Returns_2_2_2_When_Factorizing_8()
        {
            ...
            CollectionAssert.AreEqual(new long[3] { 2, 2, 2 }, factors.ToList());
        }
        ...
        public void Returns_3_3_When_Factorizing_9()
        {
            ...
            CollectionAssert.AreEqual(new long[2] { 3, 3 }, factors.ToList());
        }
        ...
        public void Returns_2_5_When_Factorizing_10()
        {
            ...
            CollectionAssert.AreEqual(new long[2] { 2, 5 }, factors.ToList());
        }
        ...
        public void Returns_2_2_3_3_When_Factorizing_36()
        {
            ...
            CollectionAssert.AreEqual(new long[4] { 2, 2, 3, 3 }, factors.ToList());
        }
        ...
        public void Returns_2_2_2_2_3_3_5_When_Factorizing_720()
        {
            ...
            CollectionAssert.AreEqual(new long[7] { 2, 2, 2, 2, 3, 3, 5 }, factors.ToList());
        }
