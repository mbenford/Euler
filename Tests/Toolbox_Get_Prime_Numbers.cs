...
namespace ProjectEuler.Tests
{
    ...
    public class Toolbox_Get_Prime_Numbers
    {
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(2);
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(3);
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(4);
            CollectionAssert.AreEqual(new int[] { 2, 3 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(5);
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(6);
            CollectionAssert.AreEqual(new int[] { 2, 3, 5 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(7);
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(8);
            CollectionAssert.AreEqual(new int[] { 2, 3, 5, 7 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(9);
            CollectionAssert.AreEqual(new int[] { 2, 3, 5, 7 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(10);
            CollectionAssert.AreEqual(new int[] { 2, 3, 5, 7 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(11);
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(12);
            CollectionAssert.AreEqual(new int[] { 2, 3, 5, 7, 11 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(13);
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(14);
            CollectionAssert.AreEqual(new int[] { 2, 3, 5, 7, 11, 13 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(15);
            CollectionAssert.AreEqual(new int[] { 2, 3, 5, 7, 11, 13 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(16);
            CollectionAssert.AreEqual(new int[] { 2, 3, 5, 7, 11, 13 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(17);
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(18);
            CollectionAssert.AreEqual(new int[] { 2, 3, 5, 7, 11, 13, 17 }, primes);
        }
        ...
        {
            IEnumerable<int> primes = Toolbox.GetPrimeNumbers(19);
